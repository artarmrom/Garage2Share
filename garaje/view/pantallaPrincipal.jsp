 ...
 <div class="Text">  
    <div>
        <div>
            ...
            <p></p>
            	<div>            	
            		<form  action="/garaje/vergarajes" method = "get"><button class = "boton" type="submit" id = "verG">Ver garajes</button>
            		<a class = "boton" href="ofrecerGaraje.jsp">Añadir garaje para alquilar</a></form>
            	</div>
            <p></p>       
    </div>
  </div>
