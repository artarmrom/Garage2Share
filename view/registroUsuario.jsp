...
<body background= garajePortada.jpg >
	<div class="header1" >
    ...
    <div>
        ...
        <div>
			...
			<div>
         	...
         	<br>
            <button type="submit"  id="registro" name="registro" >Regitrar</button>
            <p></p>
            <p></p>       
        </div>
    </div>
...
<script type="text/javascript">
  	...
  	$(document).ready(function(){
        $('#registro').click(function(){
			...
			if(fallo == 0){			
				register(nuevoUsuario,contraseña,nombre,apellido,mail,telefono);
			}
